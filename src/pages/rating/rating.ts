...
export class RatingPage {
  ...
  submitratecourse(){
    this.http.get('http://ratingstudy.ddns.net/ratingstudy/ratecourse.php/.json?cid="'+this.acourse[0].cid+'"&crate="'+this.courserate+'"&aid"'+this.userid+'"').map(res => res.json()).subscribe(
      data => {
